...
function Graduates() {
  ...
  const allImages = import.meta.glob(
    "/public/images/Graduates/*.{png,jpg,jpeg,svg}",
    {
      eager: true,
    }
  );
      ...
      <div className="px-16 max-md:px-5">
        ...
        >
          ...
          <h1 className="text-dark-text mt-3 text-justify  ">
            ...
            similique amet nulla ducimus maiores ullam voluptate quasi quis quia
            ut asperiores perspiciatis debitis ab, architecto dolorem labore
            modi sit laborum!
          </h1>
        </div>
      </div>
