        ...
        <div className="w-full h-fit px-5 max-lg:mt-2 flex flex-col pb-5">
          ...
          <div className="min-h-[990px] ">
            ...
            <div className="w-1/2 h-fit flex flex-col gap-1 px-16 max-md:px-5 ">
              ...
              <div className="max-lg:w-full flex items-start justify-start flex-wrap gap-5 mt-8">
                ...
                <div className="flex items-center justify-center max-lg:w-full bg-red-300 flex-col">
                  <div className="h-[250px] w-auto max-lg:w-full aspect-square relative overflow-hidden bg-white rounded-2xl mb-4 flex items-center justify-center">
                    <img
