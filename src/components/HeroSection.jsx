    ...
    <div className="w-full h-fit max-lg:h-fit flex items-center justify-center flex-col gap-10 max-lg:gap-5 py-10 px-0  text-dark-text">
      ...
      <div className="w-full min-h-[400px] overflow-x-clip flex items-start justify-center relative">
        ...
        <div className="absolute top-[83%] left-0 w-full h-[170px] border-t bg-body-color flex items-center justify-center gap-9">
          <img src="https://upload.wikimedia.org/wikipedia/en/e/e4/National_Bank_of_Rwanda_logo.png" className="h-[40px] saturate-0 opacity-65" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Samsung_Logo.svg/2560px-Samsung_Logo.svg.png" className="h-[40px] saturate-0 opacity-65 py-[5px]" />
        </div>
      </div>
    </div>
  );
