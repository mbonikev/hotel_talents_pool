...
const imageStyle = `h-fit min-h-full w-full bg-yellow-400 border-none outline-none shadow-xl ring-1 object-cover`;
...
function HeroSection() {
  return (
    <div className="w-full h-fit max-lg:h-fit flex items-center justify-center flex-col gap-10 max-lg:gap-5 py-10 px-0 text-dark-text">
      {/* texts */}
      <div className="w-full max-lg:w-full h-fit flex flex-col items-center justify-start gap-6 px-16 max-lg:px-5">
        <h1 className="mt-[100px] text-6xl leading-[75px] font-bold tracking-tight text-center w-full">
        ...
        <div className="w-fit flex items-start justify-center overflow-x-clip gap-4">
          ...
          <div className="flex flex-col gap-4 translate-y-[-80px]">
            {updatedImages.slice(0, 2).map((image, index) => (
              <div key={index} className="h-[300px] w-[240px] overflow-hidden rounded-2xl">
