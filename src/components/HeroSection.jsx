    ...
    <div className="w-full h-fit max-lg:h-fit flex items-center justify-center flex-col gap-10 max-lg:gap-5 py-10 px-0  text-dark-text">
      ...
      <div className="w-full min-h-[400px] overflow-x-clip flex items-start justify-center relative">
        <div className="w-fit h-fit flex items-start justify-center overflow-x-clip gap-4">
          ...
          {/* 3 */}
          <div className="flex flex-col gap-4 translate-y-[-80px] max-md:translate-y-[-10px]">
          ...
          {/* 4 */}
          <div className="flex flex-col gap-4 max-md:translate-y-[-25px]">
          ...
          {/* 6 */}
          <div className="flex flex-col gap-4 translate-y-[-80px] max-md:translate-y-[-45px]">
          ...
          {/* 7 */}
          <div className="flex flex-col gap-4 translate-y-[-130px] max-md:translate-y-[-55px]">
          ...
          {/* 8 */}
          <div className="flex flex-col gap-4 translate-y-[-35px] max-md:translate-y-[-65px]">
