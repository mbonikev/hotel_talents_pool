    ...
    <div className="w-full py-10 px-16 max-lg:px-5 gap-10 flex flex-col text-dark-text">
      ...
      <div className="w-full columns-3">
        ...
        {TestimonialsSection.testimonials.map((person, index) => (
          <div className="w-full h-fit text-center bg-white relative p-5 rounded-2xl">
            {/* lights */}
            ...
            <div className="w-full h-fit bg-red-400 absolute top-0 z-10 flex flex-col items-center justify-center gap-1">
