...
function Testimonials() {
  return (
    <div className="w-full py-10 px-16 max-lg:px-5 gap-10 flex flex-col text-dark-text flex items-center justify-center flex-col">
          ...
          <div className="flex flex-col gap-4 items-center justify-center text-center break-inside-avoid bg-[#ebebeb] relative p-5 rounded-2xl overflow-hidden ring-1 ring-stone-200">
            ...
            <div className="w-full h-full z-10 flex flex-col items-center justify-center gap-4">
              <div className="flex items-center justify-start gap-4">
                <div className="h-12 w-auto aspect-square rounded-full flex items-center justify-center relative overflow-hidden">
                  <img
                    src={person.img}
                    className="min-h-full h-fit w-full object-cover "
                  />
                </div>
