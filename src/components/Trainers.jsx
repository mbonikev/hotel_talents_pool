...
function Trainers() {
  return (
    <div className="w-full h-fit bg-red-300 px-16 max-lg:px-5 max-lg:pt-0 flex gap-5 flex-col items-start justify-between text-dark-text max-w-[1700px] mx-auto">
      <div className="w-full flex-1 h-full p-10 flex flex-col bg-[#EBEBEB] rounded-3xl relative overflow-clip">
        ...
        <div className="w-full flex-1 h-full min-h-fit absolute top-0 z-10 flex flex-col items-center justify-center gap-1">
          <h1 className="bg-orange-500 min-h-fit text-6xl font-bold w-fit text-center tracking-tight">
          ...
          {/* <div className="bg-orange-500 w-full h-full flex items-center justify-center flex-wrap gap-2 mt-7">
            {[...Array(7)].map((_, index) => (
