        ...
        <div className="w-full h-full absolute top-0 z-10 flex flex-col items-center justify-center gap-1">
          ...
          <div className="w-full flex items-center justify-center gap-2">
            <div className="flex flex-col items-center justify-center w-fit gap-2">
                <img src="https://cdn.lucidpic.com/cdn-cgi/image/w=600,format=auto,metadata=none/66c43abe18502.png" className=" h-fit min-h-[50px] w-[50px] min-w-fit aspect-square rounded-full object-cover" />
