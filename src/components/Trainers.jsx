...
function Trainers() {
  return (
    <div className="w-full h-fit min-h-[400px] bg-red-300 py-20 px-16 max-lg:px-5 max-lg:pt-0 flex gap-5 items-start justify-between text-dark-text max-w-[1700px] mx-auto">
      <div className="w-full h-full flex flex-col bg-[#EBEBEB] rounded-3xl relative overflow-clip">
        {/* lights */}
