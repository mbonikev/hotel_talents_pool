...
function Footer() {
  return (
    <div className="w-full">
      <div className="w-full bg-body-color flex flex-col items-start justify-between max-md:flex-col mt-[160px] max-md:gap-3 text-dark-text relative max-w-[1700px] mx-auto">
