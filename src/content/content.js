...
export const HeroSectionContent = {
  ...
  highlights: [
    {
      // icon: <TiFlash />,
      title: "Get Skills Faster",
      text: "it's fast and effective, get your trainings in style",
    },
    {
      // icon: <RiMedalFill />,
  ...
  columns: [
    {
      title: "OVER",
      amount: "234+",
      description: "Recipes to Explore",
    },
    {
      title: "GUIDED BY",
      amount: "14+",
...
With nine specialized centers across Rwanda, Hotel Talents Pool brings world-class hospitality training closer to you. Each center embodies our mission to empower individuals, uplift communities, and shape the future of the hospitality industry.`,
  ...
  outro: [
    "Join us to transform your passion into expertise and take your career to the next level.",
    "Explore our course offerings and start your journey with us today!",
  ],
  courses: [
    {
      id: "HTP-CN-01",
      ...
      outcome: [
        ...
        "Understand various coffee types and their origins.",
        "Learn essential barista skills, including latte art.",
    ...
    },
    {
      ...
      registerForm: "",
      outcome: [
        "Gain proficiency in various baking techniques.",
        "Understand the science of baking ingredients.",
        "Create a variety of breads and pastries.",
...
export const TestimonialsSection = {
  sectionTitle: "Real Stories, Real Inspiration",
